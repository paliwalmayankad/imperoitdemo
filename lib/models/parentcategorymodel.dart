...
class ParentCategoryModel {
  ...
  factory ParentCategoryModel.fromJson(Map<String, dynamic> json) => ParentCategoryModel(
    status: json["Status"],
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(
    id: json["Id"],
    name: json["Name"],
    isAuthorize: json["IsAuthorize"] == null ? null : json["IsAuthorize"],
  ...
  Map<String, dynamic> toJson() => {
    "Id": id,
    "Name": name,
    "IsAuthorize": isAuthorize == null ? null : isAuthorize,
